...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 /**
  * @api {cli} wechat/cli/wechat_bmyy_token_update 07. “斑马英语”公众号AccessToken更新
* @apiName wechat_cli_wechat_bm2_token_update
* @apiVersion 1.0.0
* @apiGroup WechatMp
*
  ...
  *   <code>0 * * * * /opt/php56/bin/php /data/vg02_lv01/web/bm_wonder_server/webroot/index_cli.php wechat/cli/Wechat_bmyy_token_update >> /data/vg02_lv01/web/bm_wonder_server/application/logs/crond_wechat_bmyy_token_update.log</code><br />
  */
class Wechat_bmyy_token_update extends MY_Controller {
