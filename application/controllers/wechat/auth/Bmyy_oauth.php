...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 /**
  * @api {post} https://api.dolphinlive.mobi/index.php/wechat/auth/Bmyy_oauth 03. Bmyy【斑马英语】 Web授权
  * @apiName wechat_auth_bmyy_oauth
  * @apiVersion 1.0.0
  * @apiGroup WechatBm
  *
  * @apiDescription 【斑马英语】BMYY公众号授权<br />
...
class Bmyy_oauth extends MY_Controller {
    ...
    protected function processForUser($isLogin, $me, $token_type) {
        ...
        $oauthBack = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['SERVER_NAME'] . $_SERVER['PHP_SELF'] . '_back';
