...
$config['mongo_db']['default']['hostname'] = 'dds-wz9f39f6331f87a433350.mongodb.rds.aliyuncs.com';
$config['mongo_db']['default']['port'] = '3717';
$config['mongo_db']['default']['username'] = 'guess_song';
$config['mongo_db']['default']['password'] = 'Wonder123';
$config['mongo_db']['default']['database'] = 'guess_song';
