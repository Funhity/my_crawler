...
/*     const WEGAME_IDIOM_MASTER = array(
    		...
    		'secret' => 'a3a6973afff411b18b7cadf3e17d8560',
    ); */
    ...
    //猜歌app
    const APP_GUESS_SONG = array(
        'name' => 'GUESS_SONG',
        'appid' => 'wx40fb8fd634fac00c',
        'secret' => 'aa027a9f5c7aafd70dc4f9319e0e438b',
        // 微信支付通知回调接口
        'pay_notify_url' => '',
    );

    //猜歌小游戏
    const WXGAME_GUESS_SONG = array(
        'name' => 'GUESS_SONG',
        'appid' => 'wxc28726db247e02c0',
        'secret' => 'fc2548f95abb3d036c274258879a4ce9',
        // 微信支付通知回调接口
        'pay_notify_url' => '',
    );
    ...
    //明星爱豆守护榜
    const WECHAT_STAR_RANK = array(
        'name' => 'STAR_RANK',
        'appid' => 'wxb49d3fd6a45fb86d',
        'secret' => '1aea053a61304d58ca16da04d2497237',
    );
